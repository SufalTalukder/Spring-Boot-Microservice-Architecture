...
public class AppBannerMapper {
	...
	public static AppBannerDTO toDTO(AppBannerModel entity) {
		...
		return new AppBannerDTO(entity.getAppBannerId(), entity.getAuthUserId(), entity.getAuthUserInfo(),
				entity.getAppBannerImage(), entity.getAppBannerCreatedAt(), entity.getAppBannerUpdatedAt());
	}
