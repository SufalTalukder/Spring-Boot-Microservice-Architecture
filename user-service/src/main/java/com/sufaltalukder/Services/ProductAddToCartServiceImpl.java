...
@Service
public class ProductAddToCartServiceImpl implements ProductAddToCartService {
	...
	public ApiResponse<Void> removeUserAllCarts(String addToCartIds, long userId) {
		...
		if (!notFoundCartIds.isEmpty()) {
			return new ApiResponse<>("not found",
					"The cart ID(s) were not found or do not belong to user ID: " + userId + ": " + notFoundCartIds,
					null);
		}
