...
public interface NotificationFeignService {
	...
	@PostMapping("/api/v1/elastic/auth/push-mgmt-notification")
	ApiResponse<NotificationDTO> pushMgmtNotification(@RequestBody NotificationModel notificationModel);
}
